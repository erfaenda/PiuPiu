...
"")
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.checkBox_21)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.checkBox_31)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.checkBox_41)
        self.checkBox_51 = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox_51.setObjectName("checkBox_51")
        self.buttonGroup.addButton(self.checkBox_51)
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.checkBox_51)
        self.checkBox_61 = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox_61.setObjectName("checkBox_61")
        self.buttonGroup.addButton(self.checkBox_61)
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.checkBox_61)
        self.checkBox_71 = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox_71.setObjectName("checkBox_71")
        self.buttonGroup.addButton(self.checkBox_71)
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.checkBox_71)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox1.setText(_translate("MainWindow", "&N - Доступ отсутствует"))
        self.checkBox_21.setText(_translate("MainWindow", "F - Полный доступ"))
        self.checkBox_31.setText(_translate("MainWindow", "M - доступ на изменение"))
        self.checkBox_41.setText(_translate("MainWindow", "R&X - Доступ на чтение и выполнение"))
        self.checkBox_51.setText(_translate("MainWindow", "R - Доступ только на чтение"))
        self.checkBox_61.setText(_translate("MainWindow", "W - Доступ только на запись"))
        self.checkBox_71.setText(_translate("MainWindow", "&D - доступ на удаление"))
