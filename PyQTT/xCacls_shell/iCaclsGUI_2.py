...
"")
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.radioButton_5)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.radioButton_7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton.setText(_translate("MainWindow", "N - Доступ отсутствует"))
        self.radioButton_2.setText(_translate("MainWindow", "F - Полный доступ"))
        self.radioButton_3.setText(_translate("MainWindow", "M - доступ на изменение"))
        self.radioButton_4.setText(_translate("MainWindow", "R&X - Доступ на чтение и выполнение"))
        self.radioButton_5.setText(_translate("MainWindow", "R - Доступ только на чтение"))
        self.radioButton_6.setText(_translate("MainWindow", "W - Доступ только на запись"))
        self.radioButton_7.setText(_translate("MainWindow", "&D - доступ на удаление"))
